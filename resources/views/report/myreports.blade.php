<x-app-layout>
  ...
  <h2 class="text-form-blue fw-bolder text-center display-5 mb-4">Security Incident Reports</h2>
                                  ...
                                  <div class='border col-1  border-1 d-flex'><p class='text-form-blue mt-auto mb-auto ms-auto me-auto small'><a class="btn hvr-grow bg-form-blue text-white dropshadow" href="{{route('report.edit', ['report' => $report])}}">Edit</a></p></div>
                              </div>
                            @endforeach
